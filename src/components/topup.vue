...
<script>
	...
	export default {
      ...
      if (sessionStorage.getItem('hasPay') == 0) {
        sessionStorage.hasPay = 1
        sessionStorage.num=1
        if(this.$urlstate.numb==1){
          location.href = 'https://test.cheertea.com/?code=02152cFC0FlMIc2AHvFC09dhFC052cF2&state=#/topSuccess'
        }else if(this.$urlstate.numb==2){
          location.href = 'https://wx.juyooo.com/?code=02152cFC0FlMIc2AHvFC09dhFC052cF2&state=#/topSuccess'
        }
...
//				}
            ...
            openId: openId,
            token: token,
            payAmount: JSON.parse(this.moneys),
            payWay: '01',
            payType: '06',
            reqType:0
					}
...
//					if(index==1){
          sessionStorage.setItem('hasPay', 0);
