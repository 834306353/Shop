        ...
        if(this.allChecked == true){
          for(let t in this.storeLists){
            for(let a in this.storeLists[t].goodsList){
              ...
              goodsAllPri = goodsAllPri + parseFloat(this.storeLists[t].goodsList[a].price)*parseFloat(this.storeLists[t].goodsList[a].buyCount);
      ...
      if(this.storeLists[index].show == true){
       for(let a in this.storeLists[index].goodsList){
        ...
        for(let a in this.storeLists[index].goodsList){
          ...
          this.removeByValue(this.idnumber, this.storeLists[index].goodsList[a].goodsId);
          // this.idnumber.splice(0,this.storeLists.length)
        }
        console.log(this.idnumber);
      }
    ...
    selGoods:function(index,key){
      ...
      remove: function(index) {
				if(this.storeLists[index].buyCount > 1) {
					this.storeLists[index].buyCount = parseInt(this.storeLists[index].buyCount) - 1;
